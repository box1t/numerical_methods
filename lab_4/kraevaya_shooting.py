...
# 1. где участвуют эти 5 коэф?
# 2. как вычисляется eta?
# 3. проверка с эталоном (get true) - вывести в консоль (проверка ответа ЯВНО). почему это гарантированно эталон? откуда взяли?
# 4. объясните, откуда взялись f, y1, getTrueY
# 5. поменяй имена на корректные
